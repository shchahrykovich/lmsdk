/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 549aed25ac129c12e8cd6a49e2ea5d6c)
// Runtime types generated with workerd@1.20251210.0 2025-12-17 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		CACHE: KVNamespace;
		GITHUB_URL: "https://github.com/shchahrykovich/lmsdk";
		ALLOW_TO_CREATE_MORE_THAN_ONE_TENANT: string;
		BETTER_AUTH_DISABLED_SIGN_UP: string;
		BETTER_AUTH_SECRET: string;
		OPEN_AI_API_KEY: string;
		GEMINI_API_KEY: string;
		FOR_LOCAL_TESTS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_URL" | "ALLOW_TO_CREATE_MORE_THAN_ONE_TENANT" | "BETTER_AUTH_DISABLED_SIGN_UP" | "BETTER_AUTH_SECRET" | "OPEN_AI_API_KEY" | "GEMINI_API_KEY" | "FOR_LOCAL_TESTS" | "CLOUDFLARE_AI_GATEWAY_TOKEN" | "CLOUDFLARE_AI_GATEWAY_BASE_URL">> {}
}
